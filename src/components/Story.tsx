    ...
    <section id="story" className="py-24 bg-neutral-900/30">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <p>
              "It started with a spilled coffee in Brooklyn, a clumsy apology, and a conversation that never really ended."
            </p>
            <p>
              From quiet afternoons in bookstores to hiking peaks across continents, we built a life on shared laughter and quiet understanding.
            </p>
            <p className="text-yellow-500/80">
              Now, five years later, we are ready for our greatest adventure yet.
            </p>
          </motion.div>
