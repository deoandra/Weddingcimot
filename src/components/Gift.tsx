...
export const Gift = () => {
  ...
  return (
    <section id="gift" className="py-24 relative z-10 border-t border-neutral-900">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {bankAccounts.map((account, index) => (
              ...
              >
                <h3 className="text-neutral-400 text-sm tracking-widest uppercase">{account.bank}</h3>
                <div className="text-xl font-mono text-yellow-100/90 tracking-wider">
                  {account.number}
                </div>
                <p className="text-xs text-neutral-600 uppercase tracking-wider mb-2">{account.name}</p>
